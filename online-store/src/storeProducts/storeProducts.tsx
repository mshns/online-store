...
const storeItems: IProductItem[] = [
  ...
  },
  {
    ...
    description: "Skyworth Android TV offers thousands of movies, shows and games from Google Play, Netflix, Showmax, YouTube and your favorite apps. With Chromecast built-in, you can easily cast movies, shows and photos from your Android or iOS device to you TV.",
    price: 709,
